...
function refresh_image_element(){
        array_of_images = document.getElementsByTagName('img');
    
        if(array_of_images.length = 0){
            array_of_images[0].remove();
        };
